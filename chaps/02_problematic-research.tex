...
The term {\sbf security} refers to the discipline that aims to protect against harmful attacks or actions such as vandalism, cyber-attack, or terrorism. Physical barriers, authentication, encryption, or monitoring systems are used to protect.~\cite[6i2KXzgcdbBD85cySecurity] Security mechanisms include physical barriers (e.g., access control systems), authentication protocols, encryption technologies, and surveillance systems to mitigate risks and ensure protection against deliberate threats.
...
In the context of car transportation, safety is paramount due to the direct impact of accidents on human lives, property, and societal well-being. Unlike security, which primarily addresses external threats, safety focuses on mitigating risks inherent to the operation of vehicles, such as mechanical failures, driver errors, or environmental hazards. For instance, advancements in vehicle safety systems—such as anti-lock braking systems (ABS), electronic stability control (ESC), and autonomous emergency braking (AEB)—have significantly reduced collision rates and fatalities \cite[AdminaiteMarch2016]. Moreover, safety standards, such as those mandated by the National Highway Traffic Safety Administration (NHTSA) or the European New Car Assessment Programme (Euro NCAP), ensure that vehicles are designed to protect occupants and pedestrians in the event of a crash.
...
Defining system requirements is the first and very important step for a successful and safety system or component. In this phase, it is important to define the limits, interfaces, functions, and the environment of the system.

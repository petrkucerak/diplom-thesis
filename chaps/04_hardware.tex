...
The device requires a 6 V power supply and can measure input voltages from 6 to 24 V. To utilize the CN0254 evaluation board, two points on the printed circuit board need to be connected.\fnote{Specifically, two modifications were required to enable the use of the onboard SPI and power the ADC evaluation board from a 6 V supply. These involved adjusting the amplifier’s resistance and grounding. I consulted with experts on this matter and will not discuss these changes further, as I am not an expert in this field, and this thesis does not focus on the hardware aspects of the project.} Further details on ADC communication via SPI are provided in Chapter \ref[ADCImplemChap].

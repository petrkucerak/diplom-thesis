...
As previously mentioned, since this is solely a monitoring component, compliance with SIL2 is sufficient, even though the entire system is rated SIL4.\fnote{Safety integrity level 4, detailed describes chap \ref[RAMSCycle]} 
...
Additionally, the system shall support {\it emergency signaling} in the event of a {\it Simatic PLC} shutdown. It should also allow {\it daisy-chaining} of control signals from the {\it Simatic PLC} to the LED modules within a group.  
...
* two alternating red lights with white lights,
